...
Não, eu não vi a necessidade de modificar. 
---
...
> Descreva como seu agente acessa a base de conhecimento.
 Existe duas possibilidades, injetar os dados diretamente do prompt (Ctrl + C, Ctrl + v) ou carregar os arquivos via codigo, como no exemplo abaixo.
...
" Injeção" de dados no prompt, garantindo que o agente tenha o melhor contexto possivel.
```text
...
HISTORICO DO ATENDIMENTO (data/historico_atendimento.csv)
...
Exemplo de contexto quese baseia nos dados originais da base de conhecimentos, mas os sintetiza deixando apenas as informações mais relevantes otimizando assim o consumo de tokens
```
DADOS DO CLIENTE:
- Nome: João Silva
- Perfil: Moderado
